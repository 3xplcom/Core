...
/*  This module processes BRC-20 token transfers on Bitcoin-like blockchains.
 *  It requires https://github.com/hirosystems/ordinals-api and a Core node to run.  */
...
abstract class OrdinalsBRC20Module extends CoreModule
{
    ...
    public ?array $currencies_table_fields = ['id', 'description', 'decimals'];
    public ?array $currencies_table_nullable_fields = [];
    public ?ExtraDataModel $extra_data_model = ExtraDataModel::Type; // TODO: $extra_data_details
    ...
    final public function pre_process_block($block_id)
    {
        ...
        usort($curl_results, function ($a, $b) { return [$a['tx_index']] <=> [$b['tx_index']]; });
